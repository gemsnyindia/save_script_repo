...
$DumpCommand = "mysqldump --defaults-extra-file=`"$ConfigFile`" --defaults-group-suffix=newovh $DB_NAME --routines --events --triggers --max_allowed_packet=1G --single-transaction --quick --lock-tables=false"
