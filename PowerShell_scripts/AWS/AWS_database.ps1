...
$DumpCommand = "mysqldump --defaults-extra-file=`"$ConfigFile`" --defaults-group-suffix=aws --single-transaction --quick --skip-lock-tables --max_allowed_packet=1G $DB_NAME --ignore-table=db139222657.remove_pair --ignore-table=db139222657.meta_events --ignore-table=db139222657.diamond_pairs --ignore-table=db139222657.diamond_pairs_new --ignore-table=db139222657.gems_item_L --ignore-table=db139222657.gems_item_NB --ignore-table=db139222657.gems_item_N --ignore-table=db139222657.temp_diamond_img_url_cron --ignore-table=db139222657.tmp_del_dmd"
